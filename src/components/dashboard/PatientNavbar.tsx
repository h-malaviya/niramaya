            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-20">
                    ...
                    <div className="flex items-center gap-8">
                        <Link to={APP_ROUTES.PATIENT.DASHBOARD} className="flex items-center gap-3 group">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <div className="w-10 h-10 rounded-xl bg-primary-100 flex items-center justify-center text-primary-600 group-hover:bg-primary-600 group-hover:text-white transition-all shadow-inner overflow-hidden">
